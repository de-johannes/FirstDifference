---
layout: default
title: "Chapter 12: Predictions and Testability"
breadcrumb: <a href="/">Home</a> &gt; <a href="./">Part V</a> &gt; Chapter 12
---

# Chapter 12: Predictions and Testability
...
## 12.1 What Makes a Prediction "Königsklasse"?

We introduce the term **Königsklasse** (German: "championship class") for predictions that:

1. Require **zero observed input**: No measured constants are used.
2. Require **zero calibration**: No fitting to data.
3. Require **zero free parameters**: Everything is computed from K₄.

Königsklasse predictions are the gold standard of theoretical physics. They are pure derivations from first principles.

---

## 12.2 Confirmed Predictions
...
| Signature trace | tr(η) = 2 | 2 | ✓ Confirmed |
...
| No full evaporation | K₄ remnant | Dark matter searches |
| Discrete spacetime | K₄ cells | Planck-scale dispersion |
...
- The ratio Λ<sub>obs</sub> / Λ<sub>bare</sub> ~ (ℓ<sub>P</sub> / ℓ<sub>H</sub>)² ~ 10⁻¹²².
...
<div class="highlight-box">
  ...
  <ul>
    <li>d = 3 spatial dimensions</li>
    <li>Λ > 0 (positive cosmological constant)</li>
    <li>Lorentz signature (−1, +1, +1, +1)</li>
  </ul>
  <p><strong>Testable:</strong></p>
  <ul>
    <li>Black hole remnants at Planck mass</li>
    <li>Entropy correction ΔS = ln 4</li>
    <li>Discrete spacetime structure</li>
  </ul>
</div>

The confirmed predictions validate the framework. The testable predictions provide falsifiability.

---

<nav class="chapter-nav">
  <a href="./" class="prev">← Part V Overview</a>
  <a href="chapter-13" class="next">Chapter 13: Black Holes →</a>
</nav>
